...
Route::prefix('api')->group(function () {
    ...
    Route::get('/allusers', [InboxController::class, 'getUsers'])->name('inbox.getusers');
    Route::get('/allmailscontent', [InboxController::class, 'getMailContent'])->name('inbox.getmailcontent');
    Route::post('/allmailscontent', [InboxController::class, 'saveMailContent'])->name('inbox.savemailcontent');
    Route::get('/deleteMailContent/{id}', [InboxController::class, 'deleteMailContent'])->name('inbox.deletemailcontent');
    Route::get('/editMailContent/{id}', [InboxController::class, 'editMailContent'])->name('inbox.editmailcontent');
